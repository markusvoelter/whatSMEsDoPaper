...
%\section{Numerical Analyses in Particle Physics}
%related: fabien, jetbrains lab stuff
%dsl example: sliding window tamas
...
%\section{Interfaces in Systems Engineering}
