...
writing \ic{<member> of <object>} instead of \ic{<object>.<member>} but this is
annoying because of scoping: with the latter syntax, you can easily scope the
...
So another set of constructs that is hard to avoid is arithmetic, logcial
